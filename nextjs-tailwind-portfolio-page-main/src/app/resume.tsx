      ...
      <div className="container mx-auto grid w-full grid-cols-1 items-center gap-16 lg:grid-cols-2">
        <div className="col-span-1">
          ...
          <p className="mb-4 mt-3 w-9/12 font-normal !text-gray-500">
            ...
            back-end. Diplômé en [mentionne ton parcours ou ta formation], j’ai
            acquis des compétences variées, allant de la création d’interfaces
            utilisateurs réactives en React et Vue.js à la conception de
            systèmes backend robustes avec Node.js et NestJS.
          </p>
          <div className="hover:text-white">
            <button
              onClick={handleClick}
              color="gray"
              className="flex items-center gap-2 hover:bg-black hover:rounded-lg hover:shadow-lg px-6 py-2 hover:scale-105 duration-200"
            >
              Télécharger le cv
              <ArrowRightIcon
                strokeWidth={3}
                className="h-3.5 w-3.5 text-gray-900 hover:text-white"
              />
            </button>
          </div>
        </div>
